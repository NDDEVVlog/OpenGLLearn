...
int main()
{
	...
	*/
	...
	// Store mesh data in vectors for the mesh
	std::vector<Vertex> lightVerts(std::begin(lightVertices), std::end(lightVertices));
	std::cout << "Vertex count: " << lightVerts.size() << std::endl;
	std::vector<GLuint> lightInd(std::begin(lightIndices), std::end(lightIndices));
	// Create light mesh
